...
class ChannelTracingContextTest extends TestEnv {
  ...
  @Test
  void should_record_get_response() throws Exception {
    final CollectorRegistry collectorRegistry = new CollectorRegistry();

    try (Server srv = newServer(collectorRegistry)) {
      try (Client client = newClient(srv.address(), collectorRegistry)) {
  ...
  @Test
  void should_record_file_region_response() throws Exception {
    final CollectorRegistry collectorRegistry = new CollectorRegistry();
